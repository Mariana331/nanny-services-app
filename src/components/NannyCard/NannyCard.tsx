    ...
    <div className={css.card}>
      ...
      <div className={css.age}>
        <p className={css.private_text}>
          {/* Age: <span className={css.span_age}>{nanny.age}</span> */}
        </p>
      </div>
        ...
        <div className={css.review_info}>
          <div className={css.review_name}>
            <div className={css.name_one_letter}>
              {/* <p className={css.name_one_text}>{nanny.reviews.reviewer.slice(0, 1)}</p> */}
            </div>
            <div className={css.name_full}>
              {/* <p className={css.name_full_black}>{nanny.reviews.reviewer.slice(0, 5)}.</p> */}
              <svg className={css.name_full_icon} width={16} height={16}>
                <use href="/sprite.svg#icon-star"></use>
              </svg>
              {/* <p className={css.name_full_text}>{nanny.reviews.rating}</p> */}
            </div>
          </div>
        </div>
      </div>
